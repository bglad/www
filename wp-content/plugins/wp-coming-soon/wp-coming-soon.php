...
License:
  ...
  Copyright 2012 Miriam de Paula (wpmidia@gmail.com)
...
function register_scripts_and_styles() {
	...
	if ( is_admin() ) {
		...
		wp_register_script('jquery-ui-core', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.23/jquery-ui.min.js', false, '1.8.16');
