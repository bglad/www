...
<?php if(strstr($_SERVER['HTTP_USER_AGENT'],'iPad')){ ?>
	<li><img src="<?php echo $image; ?>" alt="<?php echo $title;?>" /><a href="<?php echo $link; ?>" class="dribbble-ipad-link"><?php echo $title;?></a></li>
<?php }else{ ?>
	<div class="dribbble-title-mobile"><a href="<?php echo $link; ?>"><?php echo $title;?></a></div>
	<img src="<?php echo $image; ?>" alt="<?php echo $title;?>" data-artist="<a href=&#x0022;<?php echo $link; ?>&#x0022;><?php echo $title;?></a>" />
	<div class="dribbble-image-mobile"><a href="<?php echo $link; ?>"><img src="<?php echo $image; ?>" alt="<?php echo $title;?>" data-artist="<a href=&#x0022;<?php echo $link; ?>&#x0022;><?php echo $title;?></a>" /></a></div>
<?php } ?>
...
<p>
    ...
    <select id="wpDribbble-WidgetMaxItems" name="wpDribbble-WidgetMaxItems">
    	...
    	<option value="15" <?php if($options['maxItems'] == 15) echo "selected";?>>15</option>
    	<option value="20" <?php if($options['maxItems'] == 20) echo "selected";?>>20</option>
    	<option value="30" <?php if($options['maxItems'] == 30) echo "selected";?>>30</option>
    	<option value="40" <?php if($options['maxItems'] == 40) echo "selected";?>>40</option>
    	<option value="50" <?php if($options['maxItems'] == 50) echo "selected";?>>50</option>
    </select>
</p>
<p>
...
{
  $options = get_option("widget_wpDribbble");
  wp_register_sidebar_widget(__('Dribbble', 'flowthemes'),__('Dribbble', 'flowthemes'), 'widget_wpDribbble' ,array('description' => 'Pull in your latest Dribbble shots'));
  wp_register_widget_control('Dribbble', 'Dribbble', 'wpDribbble_control');
