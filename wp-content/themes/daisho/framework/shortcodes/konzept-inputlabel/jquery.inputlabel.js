...
(function (jQuery) {
	 ...
	 *  
	 * @param {String|Object|Bool} text Initial value of the field. Can be either a string, a jQuery reference (example: jQuery("#element")), or boolean false (default) to search for related label
		...
		return this.each(function () {
			...
			jQuery(this).bind(o.e+" blur",{obj:o},clearInput);
				...
				jQuery(this).parents("form").submit(function(){
					jQuery('textarea, input').removeClass('wpcf7-not-valid');
...
jQuery(document).ready(function(){
	jQuery("#author").inputLabel();
	jQuery("#email").inputLabel();
	jQuery("#url").inputLabel();
	jQuery("#data").inputLabel();
