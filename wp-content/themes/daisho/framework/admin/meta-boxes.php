...
function flowthemes_slideshow_meta_boxes() {
	...
	$meta_boxes = array(
		...
		'slide-image' => array( 'name' => 'slide-image', 'title' => __('Slide image:', 'flowthemes'), 'desc' => __('Put slide image here. Recommended size is around 1920x1080px and no more than 400-500kb.', 'flowthemes'), 'type' => 'upload' ),
		...
		'slide-link-name' => array( 'name' => 'slide-link-name', 'title' => __('Button link name', 'flowthemes'), 'desc' => 'Leave blank to have \'More Info\' link text on this slide.', 'type' => 'text' ),
		...
		'slide-button-icon' => array( 'name' => 'slide-button-icon', 'title' => __('Buttons icon (optional)', 'flowthemes'), 'desc' => __('Button icon.', 'flowthemes'), 'type' => 'text' ),
		'slide-color' => array( 'name' => 'slide-color', 'title' => __('Slide color', 'flowthemes'), 'desc' => 'Pick slide color.', 'type' => 'colorpicker' ),
		'slide-text-color' => array( 'name' => 'slide-text-color', 'title' => __('Text color', 'flowthemes'), 'options' => array('#ffffff' => __('White Color (#ffffff)', 'flowthemes'), '#464646' => __('Dark Color (#464646)', 'flowthemes')), 'desc' => __('For better readibility you can pick lighter or darker text color for this slide.', 'flowthemes'), 'type' => 'select' ),
		...
		'slide-color' => array( 'name' => 'slide-color', 'title' => __('Slide color', 'flowthemes'), 'desc' => __('Pick slide color.', 'flowthemes'), 'type' => 'colorpicker' )
	);
	...
	function printThickBoxesbyFlow(){
		...
		var form_vimeo = jQuery('<div id="vimeo-form"><table id="vimeo-table" class="form-table">\
			<tr>\
				...
				<small><?php _e('Specify Vimeo <strong>video ID</strong> or video LINK here.', 'flowthemes'); ?></small>\
			</tr>\
			<tr>\
				<th><label for="text_color"><?php _e('Text color (and cursor color)', 'flowthemes'); ?></label></th>\
